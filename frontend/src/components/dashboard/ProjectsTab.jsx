    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">Configure active project boards for your company office departments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((proj) => (
          <div key={proj.id} className="bg-[#111827] border border-gray-800 rounded-2xl p-6 shadow-lg flex flex-col justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mb-6">UUID: <span className="font-mono text-xs">{proj.id}</span></p>
            </div>
            <div className="flex justify-between items-center text-xs text-gray-400 border-t border-gray-800/80 pt-4">
        ...
        <div className="bg-[#111827]/40 border border-dashed border-gray-800 rounded-2xl p-6 flex flex-col justify-center">
          <h4 className="text-sm font-semibold text-gray-400 mb-4 text-center">Add New Project</h4>
